...
const LinkedInPlateFormInputs = ({
  ...
  return (
    <div className="py-2">
      <p>
        Streambed can post to Facebook pages or groups via your account <br />{" "}
        For personal timeline posts, locate your post in the Content Stream on
...
export default LinkedInPlateFormInputs;
