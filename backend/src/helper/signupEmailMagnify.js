...
module.exports = signupEmail = (
  user,
  link,
  subject = "Welcome to Streambed Magnify"
) => {
  sendMail({
    to: user.email,
    subject: subject,
								...
								>
									...
									<tr>
										<td  class="text-body" style="font-size: 16px; line-height: 20px; color: #707070; font-weight: 500; font-family: 'Montserrat', sans-serif;">
											You’re almost there! Please confirm your email by 
											clicking the link below, or copy and pasting the link in your browser.
										</td>
									</tr>
									<tr>
										<td height="40">&nbsp;</td>
