...
async function sendemail(email, user, author, link, permalink) {
  {
    sendMail({
      to: email,
								...
								>
									...
									<tr>
										<td  class="text-body" style="font-size: 16px; line-height: 20px; color: #707070; font-weight: 500; font-family: 'Montserrat', sans-serif;">
											 ${author}
                       has tagged you in their Facebook post via Streambed’s publishing tool! Verify it’s you and get real time access to the post analytics.
										</td>
									</tr>
									<tr>
										<td height="20">&nbsp;</td>
