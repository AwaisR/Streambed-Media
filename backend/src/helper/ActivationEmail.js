						...
						<tr>
							<td class="inner-wrap" style="padding: 0 100px;">
								...
								>
									...
									<tr>
										<td  class="text-body" style="font-size: 16px; line-height: 20px; color: #707070; font-weight: 500; font-family: 'Montserrat', sans-serif;">
											You’re ready to start publishing and sharing videos with your 
											friends and colleagues! Need a refresher on who we are? 
											<a href="https://www.youtube.com/watch?v=BbfWRkrXNu4" style="text-decoration: none; color: #0099CD;">Watch this video.</a>
										</td>
									</tr>
									<tr>
										<td height="20">&nbsp;</td>
									...
									<tr>
										<td  class="text-body" style="font-size: 16px; line-height: 20px; color: #707070; font-weight: 500; font-family: 'Montserrat', sans-serif;">
											Let’s publish your first video — 
											<a href="https://app.streambedmedia.com/" style="text-decoration: none; color: #0099CD;">click here</a> to access your profile.
										</td>
									</tr>
									<tr>
										<td height="40">&nbsp;</td>
									...
									<tr>
										<td align="start">
											<table align="start" border="0" width="100%" cellspacing="0" cellpadding="0" 
											...
											>
												<tr>
													<td style="padding-right: 10px;">
														...
														>
															<tr>
																<td align="start" style="width: 48px; height: 48px; border: 0.5px solid #939598; display: inline-block; border-radius: 8px; padding: 20px;">
																	<table border="0" cellspacing="0" cellpadding="0" align="center" width="100%">
																		<tr>
																			<td align="center" style=" 
																				width: 44px; height: 44px; border: 2px solid #0099CD; display: block; border-radius: 50%;  text-align: center;
																				font-size: 24px; color: #0099CD;  margin: 0 auto; font-weight: 700; line-height: 44px;" >
																				1
																			</td>
																		</tr>
																	</table>
													...
													<td align="center" style="display: inline-block; width: 310px; border: 0.5px solid #939598; border-radius: 8px; padding: 34px 7px;">
														<table align="start" border="0" cellspacing="0" cellpadding="0" 
															style="font-family: 'Montserrat', sans-serif;"
														>
															<tr>
																<td style="font-size: 16px; text-align: center; line-height: 20px; color: #707070; font-weight: 500; font-family: 'Montserrat', sans-serif;">
																	Log in
																</td>
															</tr>
														</table>
										...
										<td align="start">
											...
											>
												<tr>
													...
													<td align="center" style="display: inline-block; width: 310px; border: 0.5px solid #939598; border-radius: 8px; padding: 24px 7px;">
														<table align="start" border="0" cellspacing="0" cellpadding="0" 
															style="font-family: 'Montserrat', sans-serif;"
														>
															<tr>
																<td style="font-size: 16px; text-align: center; line-height: 20px; color: #707070; font-weight: 500; font-family: 'Montserrat', sans-serif;">
																	Tag the people and/or companies that helped bring your content to life
																</td>
															</tr>
														</table>
													</td>
										...
										<td align="start">
											...
											>
												<tr>
													...
													<td align="center" style="display: inline-block; width: 310px; border: 0.5px solid #939598; border-radius: 8px; padding: 14px 7px;">
														<table align="start" border="0" cellspacing="0" cellpadding="0" 
															style="font-family: 'Montserrat', sans-serif;"
														>
															<tr>
																<td style="font-size: 16px; text-align: center; line-height: 20px; color: #707070; font-weight: 500; font-family: 'Montserrat', sans-serif;">
																	Ask your collaborators to verify that they’re in the content
																	<small style="display: block; font-size: 12px; color: #939598;">(they’ll get an email with instructions)</small>
																</td>
															</tr>
														</table>
													</td>
									...
									<tr>
										<td height="8" cellspacing="0" cellpadding="0">&nbsp;</td>
									</tr>
									<tr>
										<td align="start">
											<table align="start" border="0" width="100%" cellspacing="0" cellpadding="0" 
												...
												<tr>
													...
													<td align="center" style="display: inline-block; width: 310px; border: 0.5px solid #939598; border-radius: 8px; padding: 24px 7px;">
														...
														>
															<tr>
																<td style="font-size: 16px; text-align: center; line-height: 20px; color: #707070; font-weight: 500; font-family: 'Montserrat', sans-serif;">
																	Begin receiving enhanced analytics about your content!
																</td>
															</tr>
														</table>
													</td>
