...
async function sendemail(p_id, v_title, email, user, author, link, permalink) {
  {
    sendMail({
      to: email,
								...
								>
									...
									<tr>
										<td  class="text-body" style="font-size: 16px; line-height: 20px; color: #707070; font-weight: 500; font-family: 'Montserrat', sans-serif;">
											 ${author}
                       has tagged you in their Instagram post via Streambed’s publishing tool! Verify it’s you and get real time access to the post analytics.
										</td>
									</tr>
									<tr>
										<td height="20">&nbsp;</td>
									...
									<tr>
										<td  class="text-body" style="font-size: 16px; line-height: 20px; color: #707070; font-weight: 500; font-family: 'Montserrat', sans-serif;">
											...
											<a href="${permalink}" style="color: #0099CD; text-decoration: none;">here</a>
										</td>
									</tr>
									<tr>
										<td height="20">&nbsp;</td>
